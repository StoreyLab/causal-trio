...
($(y1) + (0, 1.3)$) node(g1) {$(1, 0)$}
($(y2) + (0, 1.3)$) node(g2) {$(1, 0)$}
($(y3) + (0, 1.3)$) node(g3) {$(1, 1)$}
($(y4) + (0, 1.3)$) node(g4) {$(0, 1)$}
($(y5) + (0, 1.3)$) node(g5) {$(0, 0)$}
...
\draw[->, line width = 1, color = black] (y3m) to (t2);
\draw[->, line width = 1, color = black] (y3p) to (t3);
\draw[->, line width = 1, color = black] (y4p) to (t4);
\draw[->, line width = 1, color = black] (y7p) to (t5);

\draw[->, line width = 1, color = black] (y2p) to (c1);
\draw[->, line width = 1, color = black] (y4m) to (c2);
\draw[->, line width = 1, color = black] (y5m) to (c3);
